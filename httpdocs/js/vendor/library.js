...
/* jQuery.inputMath.js: allows auto-calculated math in input fields via =#+#, or =(#+#)*#, etc. */
(function($) {
    $.fn.inputMath = function(n) {
        this.bind(n || "blur", function(e) {
            var v = this.value,r;
            v.charAt(0) == "=" && (r = eval(v.replace(/([^\d\.\(\)\+\-\*\/])/g, "")),isNaN(r) || (this.value = r));
            if (this.value == r) $(this).change();
        });
        return this
    }
})(jQuery);
